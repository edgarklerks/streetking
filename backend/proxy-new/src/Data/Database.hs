...
dbconn = connectPostgreSQL "host=localhost port=5432 dbname=postgres user=postgres password=wetwetwet"
...
cNEQ :: Selection -> Value -> Constraint
cNEQ = Constraint OpNEQ
