<form id="edit_form" action="account/put" method="post">
	...
	<div class="edit-element-data-container">
		<div class="edit-element-data-box inner-scroll-box">
			<div class="edit-element-data-box-inner">
				...
				<div><label>city:</label><input type="text" name="city" value="[:0.city]" list="city"/></div>
		...
		<div class="edit-element-image-box">
			<div class="edit-element-image-container edit-element-image-part" style='background-image:url([:0.picture_small])'>&nbsp;</div>
		</div>
