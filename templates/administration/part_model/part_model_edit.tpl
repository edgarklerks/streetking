...
<div><label>parameter1_type_id:</label><input type="text" name="parameter1_type_id" value="[:0.parameter1_type_id]"/></div>
...
<div><label>part_modifier_id:</label><input type="text" name="part_modifier_id" value="[:0.part_modifier_id]"/></div>
<div><label>part_type_id:</label><input type="text" name="part_type_id" value="[:0.part_type_id]"/></div>
