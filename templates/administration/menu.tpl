<ul class="sf-menu">
	<li class="current">
		<a href="#">Parts</a>
		<ul>
			<li><a href="#part_model/get" module="PART_MODEL_LIST">Part models</a></li>
			<li><a href="#part_type/get" module="PART_TYPE_LIST">Part types</a></li>
			<li><a href="#part_instance/get" module="PART_INSTANCE_LIST">Part instance</a></li>		
			<li><a href="#part_modifier/get" module="PART_MODIFIER_LIST">Part modifier</a></li>
		</ul>
	</li>
	<li>
		<a href="#">Cars</a>
