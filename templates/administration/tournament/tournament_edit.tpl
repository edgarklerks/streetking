<div style="float:left">
	...
	<div><label>done:</label><input id="done" type="text" name="done" value="[:0.done]"/></div>
	...
	<div><label>running:</label><input type="text" id="running" name="running" value="[:0.running]"/></div>
