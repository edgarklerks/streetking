				...
				<div class="car-info-part-element-infotext-container">
					...
					[:when (unique == false)]{
						<div class="car-info-part-element-info-data-box-absolute">
							<div class="car-info-part-element-info-data-box-name">Improve <span>[:eval floor(improvement/100)]</span> %</div>
							<div class="car-info-part-element-progress-bar-box ui-corner-all-2px">
								<div class="car-info-part-element-progress-bar car-info-part-element-progress-improve ui-corner-all-1px" style="width:[:eval (improvement/100)]%"></div>
							</div>
						</div>
					}
				</div>
