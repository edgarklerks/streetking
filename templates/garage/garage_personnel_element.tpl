...
<!--
<div class="personnel-element-container backgound-darkgray">
	<div class="personnel-element-image-container">
		<div class="personnel-element-image-box" style="background-image:url(img/personnel/[:gender]_[:picture].png)">&nbsp;</div>
	</div>
	<div class="personnel-element-info-container">
		<div class="personnel-element-info-box">
			...
			<div class="personnel-element-info-data">
				<div class="personnel-element-info-data-box-container">
					<div class="personnel-element-info-data-box">
						<div class="personnel-element-info-data-name"></div>
						<div class="progress-bar-box-small ui-corner-all-2px">
							<div class="progress-bar-small ui-corner-all-2px" style=""></div>
						</div>
					</div>
					<div class="personnel-element-info-data-box">
						<div class="personnel-element-info-data-name"></div>
