<div class="garage-part-element-container backgound-darkgray">
	...
	<div class="garage-part-element-image-container [:when (improvement > 0 & unique == false)]{garage-part-element-image-container-improved}[:when (unique)]{garage-part-element-image-container-unique} black-icons-100 garage-part-element-image-container-image" style='background-image:url([:eval IMAGESERVER("[\"part\","+id+",\""+name+"\"]")])'><div class="garage-part-element-image-zoom element-image-zoom">&nbsp;</div></div>
...
<!--				<div>Price:&nbsp;<span>SK$ [:price]</span></div>-->
				...
				[:when (unique == false)]{
					<div class="garage-part-element-info-data-box-absolute">
						<div class="garage-part-element-info-data-box-name">Improve <span>[:eval floor(improvement/100)]</span> %</div>
						<div class="garage-part-element-progress-bar-box ui-corner-all-2px">
							<div class="garage-part-element-progress-bar garage-part-element-progress-improve ui-corner-all-1px" style="width:[:eval (improvement/100)]%"></div>
						</div>
					</div>
				}
			</div>
			...
			<div class="garage-part-element-infobar-container">
				<div class="garage-part-element-info-data-box">
					<div class="garage-part-element-info-data-box-name">[:parameter1_name]: <span>[:parameter1_values.text]</span> [:when (parameter1_unit != null)]{[:parameter1_unit]}</div>
					<div class="garage-part-element-progress-bar-box ui-corner-all-1px">
						<div class="garage-part-element-progress-bar ui-corner-all-1px" style="width:[:parameter1_values.bar]%"></div>
					</div>
				</div>
				[:when (parameter2_name)]{
					<div class="garage-part-element-info-data-box">
						<div class="garage-part-element-info-data-box-name">[:parameter2_name]: <span>[:parameter2_values.text]</span> [:when (parameter2_unit != null)]{[:parameter2_unit]}</div>
						<div class="garage-part-element-progress-bar-box ui-corner-all-1px">
							<div class="garage-part-element-progress-bar ui-corner-all-1px" style="width:[:parameter2_values.bar]%"></div>
						</div>
					</div>
				}
				...
				<div class="garage-part-element-info-data-box-absolute">
					...
					<div class="garage-part-element-progress-bar-box ui-corner-all-2px">
						<div class="garage-part-element-progress-bar garage-part-element-progress-used ui-corner-all-1px" style="width:[:eval floor(wear/100)]%"></div>
					</div>
				</div>
			</div>
