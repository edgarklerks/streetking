<div class="race-car-box-container corner-box">
	[:when (race.data.length == 2)]{
		<div class="race-car-element-container backgound-darkgray">
			<div class="race-car-element-image-container race-car-element-image-container-image" style="background-image:url(test_store/car_[:race.data.0.rd_car.id].jpg?t=[:eval TIMESTAMP(id)])">&nbsp;</div>
			<div class="race-car-element-vertical-line">&nbsp;</div>
			<div class="race-car-element-image-container race-car-element-image-container-image" style="background-image:url(test_store/car_[:race.data.1.rd_car.id].jpg?t=[:eval TIMESTAMP(id)])">&nbsp;</div>
		</div>
