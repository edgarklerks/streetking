		...
		<div class="race-car-element-container">
			...
			<div class="float-right">
				...
				<div class="speedometer-box">
					...
					<div id="digital-speedometer-[:race.data.1.rd_user.id]" class="digital-speedometer">10</div>
				</div>
			</div>
		</div>
			...
			<div class="float-right">
				<div class="race-car-element-infotext-container">
					<div class="race-car-element-infotext-manufacture-box">
						<div class="race-car-element-infotext-manufacture-logo-box normal" style="background-image:url(images/manufacturers/[:race.data.0.rd_car.manufacturer_name]_logo.png);"></div>
					...
					<div class="race-car-element-infotext-additional-box">
