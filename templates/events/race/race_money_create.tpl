<div class="declare-your-own-race-box" title="Declare your own race">
	<form id="race-money-create">
		<input type="hidden" name="track_id" id="track_id" value="" />
		<div class="error">&nbsp;</div>
		<div id="declare-your-own-race-car-box" class="declare-your-own-race-car-box"></div>
		...
		<div class="declare-your-own-race-money-box">
			...
			<div class="buttons-panel">
				<input type="button" value="create" id="create" class="button" module="">
			</div>
		</div>
	</form>
</div>